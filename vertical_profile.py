...
def plotfig(means):
    ...
    plt.axvline(color='k')
    plt.savefig('/home/lsaffi/plots/36h_vertical_profile.png')
    plt.legend(loc='best')
    plt.savefig('/home/lsaffi/plots/36h_vertical_profile_legend.png')


if __name__ == '__main__':
    filename = '/projects/diamet/lsaffi/xjjhq/xjjhqa_036.pp'
